...
Route::post('/cartupdate', 'FrontEndController@cartupdate')->name('update.cart');
...
Route::get('/vendors', 'Auth\VendorLoginController@showLoginFrom')->name('vendor.login');
Route::post('/vendors/login', 'Auth\VendorLoginController@login')->name('vendor.login.submit');
Route::get('/vendors/registration', 'Auth\VendorRegistrationController@showRegistrationForm')->name('vendor.reg');
Route::post('/vendors/registration', 'Auth\VendorRegistrationController@register')->name('vendor.reg.submit');
...
Route::get('/test', function () {
    return view('includes.1newmaster');
});
Route::get('/1', 'FrontEndController@index1');