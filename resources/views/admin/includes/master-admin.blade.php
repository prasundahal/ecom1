...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    ...
    <div class="navbar-header">
        ...
        <a class="navbar-brand" href="{!! url('admin/dashboard') !!}">
            <img class="logo" src="{!! url('public/assets/images/logo') !!}/{{$settings[0]->logo}}" alt="LOGO">
        </a>
    </div>
    <!-- Top Menu Items -->
    ...
    <div class="collapse navbar-collapse navbar-ex1-collapse">
        <ul class="nav navbar-nav side-nav">
            ...
            <li>
                <a href="{!! url('admin/orders') !!}"><i class="fa fa-fw fa-usd"></i> Cases </a>
            </li>
            <li>
            ...
            <li>
                <a href="{!! url('admin/customers') !!}"><i class="fa fa-fw fa-user"></i> Users</a>
            </li>
            <li>
...
<script type="text/javascript" src="{{ URL::asset('public/assets/js/Chart.min.js')}}"></script>
