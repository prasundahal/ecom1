...
@section('content')
    ...
    <section style="background: url({{url('/')}}/public/assets/images/{{$settings[0]->background}}) no-repeat center center; background-size: cover;">
                        ...
                        <div class="product-filter-rightDiv">
                            ...
                            <div class="row">
                                <div class="col-md-12 text-center">
                                    <img id="load" src="{{url('/public/assets/images/default.gif')}}" style="display: none;width: 80px;">
                                </div>
                                <div class="col-md-12 text-center">
