...
<head>
    ...
    <link rel="icon" type="image/png" href="{{url('/')}}/public//public/assets/images/{{$settings[0]->favicon}}" />
    ...
    <link href="{{ URL::asset('/public/assets/css/bootstrap-slider.min.css')}}" rel="stylesheet">
    <link href="{{ URL::asset('/public/assets/css/dataTables.bootstrap.min.css')}}" rel="stylesheet">
    <link href="{{ URL::asset('/public/assets/css/genius-slider.css')}}" rel="stylesheet">
    <link href="{{ URL::asset('/public/assets/css/go-style.css')}}" rel="stylesheet">
            ...
            <header class="type-1">
                ...
                <div class="header-product">
                    <div class="logo-wrapper">
                        {{-- <a href="{{url('/')}}" id="logo">
                            <img alt="" src="{{ URL::asset('/public/assets/images/logo')}}/{{$settings[0]->logo}}">
                        </a> --}}
                    </div>
                        ...
                        <div class="line-entry">
                            <div class="header-top-entry increase-icon-responsive open-search-popup">
                             ...
                             <div class="header-top-entry increase-icon-responsive login">
                                <a href="{{url('/vendors')}}" class="title"><i class="fa fa-group"></i> <span>{{$language->vendor}}</span></a>
                            </div> 
                            <div class="header-top-entry increase-icon-responsive login">
                                ...
                                <ul class="latest-tweet">
                                    ...
                                    <li>
                                        <a href="{{url('/blog')}}/{{$lblog->id}}">
                                            <img src="{{url('//public/assets/images/blog')}}/{{$lblog->featured_image}}" alt="">
...
<script src="{{ URL::asset('/public/assets/js/jquery.zoom.js')}}"></script>
...
<script src="{{ URL::asset('/public/assets/js/genius-slider.js')}}"></script>
...
<script src="{{ URL::asset('/public/assets/js/notify.js')}}"></script>
