                                ...
                                <div class="tab-pane" id="brands">
                                    ...
                                    <table class="table" id="example">
                                        ...
                                        @foreach($brands as $brand)
                                            <tr>
                                                <td><img src="{{url('public/assets/images/brands')}}/{{$brand->image}}"></td>
                                                <td>
                                ...
                                <div class="tab-pane" id="banners">
                                    ...
                                    <table class="table" id="example">
                                        ...
                                        @foreach($banners as $banner)
                                            <tr>
                                                <td><img style="max-width: 250px;" src="{{url('public/assets/images/brands')}}/{{$banner->image}}"></td>
                                                <td>{{$banner->link}}</td>
                                                <td>
                                    ...
                                    <form method="POST" action="banner/large" class="form-horizontal form-label-left" enctype="multipart/form-data">
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <img class="col-md-10" src="../public/assets/images/{{$pagedata->large_banner}}">
                                            </div>
